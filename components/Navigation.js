  ...
  return (
    <div className="bg-neutral-50 dark:bg-black px-6 sticky top-0 z-20 transition-colors">
      <div className="flex justify-between items-baseline sm:items-center font-serif border-b border-tf-red dark:border-tf-purple transition-colors px-2 pt-5 pb-4">
        <Link href="/about">
            <a className="uppercase tracking-widest text-[0.6rem] sm:text-base transition-colors text-tf-red dark:text-tf-purple focus:outline-dotted outline-1 outline-black outline-offset-2">
              About
            </a>
          </Link>
          <div className="md:pl-2 md:pr-12 text-center">
            <Link href="/">
              <a className="text-xs md:text-lg lg:text-xl uppercase tracking-widest transition-colors text-tf-red dark:text-tf-purple focus:outline-dotted outline-1 outline-black outline-offset-0">
